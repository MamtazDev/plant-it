    ...
    <section className="out_three_tiers px-5 md:px-0 py-[80px] pb-[160px] md:py-[174px]">
      <div className="container">
        <div className="section_heading pb-[50px] md:pb-[100px]">
          <h3 className="service_sub_heading text-[28px] md:text-[70px] font-fieldWorkGeoRegular text-[#132B51] text-start md:text-center">
            Our three
            ...
            {TiesrsData.map((tiersItem, index) => (
              <div
                ...
                <div clasName="tiers_head">
                  <h3 className="text-[#0E203A] font-semibold text-[22px] md:text-[32px] capitalize font-fieldWorkGeoRegular pb-[16px]">
                    {tiersItem.tierTitle}
                  </h3>
