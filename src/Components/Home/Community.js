      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-deepBlue text-base lg:text-2xl font-fieldworkGeoLight font-light mb-10 lg:mb-[73px]  leading-[160%]">
            ...
            <button className="text-deepBlue text-[15px] lg:text-2xl font-fieldworkGeoBold font-semibold capitalize px-[31px] lg:px-[50px] py-[9px] lg:py-[14px] bg-mint rounded-[80px]">
              Join Us at a meetup
            </button>
          </div>
        </div>
