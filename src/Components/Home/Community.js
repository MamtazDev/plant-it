    ...
    <div className="community pt-[194px] pb-[185px]">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <p className="subtitle text-deepBlue mb-[47px]">
              Part of the <br /> <span>community</span>{" "}
            </p>
            <p className="text-deepBlue text-2xl font-light mb-[73px]">
            ...
            <button className="text-deepBlue text-2xl font-semibold capitalize px-[50px] py-[14px] bg-mint rounded-[80px]">
              Join Us at a meetup
            </button>
          </div>
        </div>
